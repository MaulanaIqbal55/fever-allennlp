...
if __name__ == '__main__':
    ...
    matrix_dir = os.path.dirname(args.matrix_path)

    with open(matrix_dir + '/row.json', 'r') as f:
        row = json.load(f)
    
    with open(matrix_dir + '/col.json', 'r') as f:
        col = json.load(f)
        
    with open(matrix_dir + '/data.json', 'r') as f:
        data = json.load(f)
